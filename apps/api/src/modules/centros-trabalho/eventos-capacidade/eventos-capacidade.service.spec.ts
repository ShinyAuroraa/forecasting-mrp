...
describe('EventosCapacidadeService', () => {
  let service: EventosCapacidadeService;

  beforeEach(() => {
    jest.clearAllMocks();
    service = new EventosCapacidadeService(mockRepository as any);
  });

  describe('create', () => {
    it('should delegate to repository', async () => {
      const dto = { centroTrabalhoId: 'ct1', tipo: 'QUEBRA', dataEvento: '2026-03-01' };
